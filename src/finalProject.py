...
def enemy(screen, x, y, i, enemy_image):
...
#player
    ...
    for i in range(num_of_enemies):
        ...
        enemy_hit_box.append(pygame.Rect(enemyX[i], enemyY[i], enemyX[i] + 64, enemyY[i] - 64)) 
...
#game loop
    ...
    #collision with bullet
            ...
            enemy(screen, enemyX[i], enemyY[i], i, enemy_image)
